    ...
    <section className="relative h-screen w-full shrink-0 flex flex-col bg-white overflow-hidden">
         <div className="container mx-auto px-6 h-full flex flex-col justify-center items-center text-center relative z-10">
            ...
            >
                ...
                <motion.h2 
                    className="text-6xl md:text-9xl font-black uppercase tracking-tighter mb-10 interactive hover:text-copper transition-colors cursor-none text-black relative z-10"
         ...
         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[20vw] font-bold text-black/5 pointer-events-none whitespace-nowrap z-0">
            CONTACT
         </div>
    </section>
  );
